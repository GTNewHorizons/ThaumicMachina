...
public class FXBeam extends EntityFX {
    ...
    public FXBeam(World par1World, double f, double f2, double f4, double par8, double par10, double par12, int par14,
        int par15, String texture) {
    ...
    public FXBeam(World world, double f, double f2, double f3, double d, double d2, double d3, int par4,
        String texture) {
    ...
    public void renderParticle(Tessellator tessellator, float f, float f1, float f2, float f3, float f4, float f5) {
        ...
        float var12 = (float) ((double) (-var11) * this.speed
            - (double) MathHelper.floor_float((float) (-var11 * 0.1f)));
