...
public class RenderMetaphysical extends TileEntitySpecialRenderer {
    ...
    public void renderUnitBoxWithUV(TileEntity te, float paramFloat1, float paramFloat2, float paramFloat3,
        Tessellator paramTessellator, float paramFloat4, float paramFloat5, float paramFloat6, float paramFloat7,
        String texture) {
        ...
        paramTessellator.addVertexWithUV(
            (double) paramFloat1,
            (double) (paramFloat2 + 1.0f),
            (double) paramFloat3,
            (double) paramFloat4,
            (double) paramFloat7);
        paramTessellator.addVertexWithUV(
            (double) (paramFloat1 + 1.0f),
            (double) (paramFloat2 + 1.0f),
            (double) paramFloat3,
            (double) paramFloat6,
            (double) paramFloat7);
