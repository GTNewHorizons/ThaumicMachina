...
public class ModelNodeTransmodifier extends ModelBase {
    ...
    final ModelRenderer Base1;
    final ModelRenderer Centre;
    final ModelRenderer Base2;
    final ModelRenderer TopPlate;
    final ModelRenderer Arm1;
    final ModelRenderer Arm2;
    final ModelRenderer Arm3;
    final ModelRenderer Arm4;
    ...
    public ModelNodeTransmodifier() {
        ...
        this.Centre = new ModelRenderer(this, 0, 21);
        ...
        this.TopPlate = new ModelRenderer(this, 0, 47);
        ...
        this.Arm1 = new ModelRenderer(this, 0, 38);
        ...
        this.Arm2 = new ModelRenderer(this, 12, 38);
        ...
        this.Arm3 = new ModelRenderer(this, 18, 38);
        ...
        this.Arm4 = new ModelRenderer(this, 6, 38);
