...
import jcm2606.thaumicmachina.asm.TMFMLLoadingPlugin;
...
public class TMClassTransformer
implements IClassTransformer {
    ...
    public byte[] transform(String name, String transformedName, byte[] basicClass) {
        ...
        if (name.equals("thaumcraft.client.renderers.models.gear.ModelWand") || name.equals("thaumcraft.client.renderers.models.ModelWand")) {
    ...
    public byte[] patchItemWandCastingClass(String className, byte[] bytes) {
        ...
        while (methodIterator.hasNext()) {
            ...
            if (mnode.name.equals("getMaxVis") && mnode.desc.equals("(L" + this.itemStackClassPath + ";)I")) {
                ...
                injectionList.add((AbstractInsnNode)new MethodInsnNode(184, "jcm2606/thaumicmachina/wand/WandAugmentationHandler", "handleMaxVisMethod", "(L" + this.itemStackClassPath + ";)I"));
            ...
            if (mnode.name.equals("hasRunes") && mnode.desc.equals("(L" + this.itemStackClassPath + ";)Z")) {
                ...
                injectionList.add((AbstractInsnNode)new MethodInsnNode(184, "jcm2606/thaumicmachina/wand/WandAugmentationHandler", "handleHasRunesMethod", "(L" + this.itemStackClassPath + ";)Z"));
                mnode.instructions.insert(mnode.instructions.get(index), injectionList);
                TMFMLLoadingPlugin.log("Patched method.", "INFO");
            }
            if (!mnode.name.equals("getConsumptionModifier") || !mnode.desc.equals("(L" + this.itemStackClassPath + ";" + "L" + EntityPlayer.class.getName().replace(".", "/") + ";Lthaumcraft/api/aspects/Aspect;Z)F")) continue;
            ...
            injectionList.add((AbstractInsnNode)new MethodInsnNode(184, "jcm2606/thaumicmachina/wand/WandAugmentationHandler", "handleConsumptionModifierMethod", "(L" + this.itemStackClassPath + ";Z)F"));
            mnode.instructions.insert(mnode.instructions.get(index), injectionList);
            iterator = mnode.instructions.iterator();
            i = -1;
            while (iterator.hasNext()) {
    ...
    public byte[] patchModelWandClass(String className, byte[] bytes) {
        ...
        while (methodIterator.hasNext()) {
            ...
            while (iterator.hasNext()) {
                ...
                if (!(ldcNode.cst instanceof Double) || (d = ((Double)ldcNode.cst).doubleValue()) != (double)-0.01f) continue;
                targetNode = currNode;
                index = i - 8;
            }
            mnode.instructions.remove(mnode.instructions.get(index + 2));
            ...
            injectionList.add((AbstractInsnNode)new VarInsnNode(25, 1));
            injectionList.add((AbstractInsnNode)new MethodInsnNode(184, "jcm2606/thaumicmachina/wand/WandAugmentationHandler", "handleRuneRendererDouble", "(L" + this.itemStackClassPath + ";)D"));
            mnode.instructions.insert(mnode.instructions.get(index + 1), injectionList);
            mnode.instructions.remove(mnode.instructions.get((index -= 14) + 1));
            injectionList = new InsnList();
            injectionList.add((AbstractInsnNode)new VarInsnNode(25, 1));
            injectionList.add((AbstractInsnNode)new MethodInsnNode(184, "jcm2606/thaumicmachina/wand/WandAugmentationHandler", "handleRuneRendererPasses", "(L" + this.itemStackClassPath + ";)I"));
            mnode.instructions.insert(mnode.instructions.get(index), injectionList);
            TMFMLLoadingPlugin.log("Patched method.", "INFO");
            break;
        }
